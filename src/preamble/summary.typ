...
This is especially true for _constrained devices_, or embedded devices, which are small computers that are often used for internet of things applications, such as your smart thermostat, fitness tracker, WiFi lights, and so on.
...
These obstacles can be split into four main challenges.
...
The stateful out-of-place debugger also addresses the third challenge, by capturing all asynchronous events, such as hardware interrupts, and forwarding them to the client.
...
The fourth challenge is addressed by our third contribution, and final debugger called _MIO_, a multiverse debugger for input and output programs on constrained devices.
